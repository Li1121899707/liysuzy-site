...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/index/cloud.css" />
    <!-- bootstrap & own -->
    ...
    <div class="col-md-12">
        ...
        <div class="mainBox">
            ...
            <section class="demo">
                <h2>阴阳师小站</h2>
                <div class="grid">
                    <div class="box" onclick="window.location.href='${pageContext.request.contextPath}/yysontama'">
                    ...
                    <div class="box" onclick="window.location.href='${pageContext.request.contextPath}/yysvoice'">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                            <line class="top" x1="0" y1="0" x2="900" y2="0"/>
                            <line class="left" x1="0" y1="460" x2="0" y2="-920"/>
                            <line class="bottom" x1="300" y1="460" x2="-600" y2="460"/>
                    ...
                    <div class="box" onclick="window.location.href='${pageContext.request.contextPath}/yysabout'">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                            <line class="top" x1="0" y1="0" x2="900" y2="0"/>
                            <line class="left" x1="0" y1="460" x2="0" y2="-920"/>
                            <line class="bottom" x1="300" y1="460" x2="-600" y2="460"/>
        ...
        <div class="footer">
            ...
            2018 | <a href="yys_about.html" style="color: #ac9768">本网站仅用于个人交流！网站资源版权归网易所有！</a>
        </div>
    </div>
</div>
<!-- content end -->
