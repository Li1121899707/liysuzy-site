                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block">
                            <i>
                                ...
                                <a href="${pageContext.request.contextPath}/sidenav/capriccio_add" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>添加随想</span>
                                    <i class="am-icon-pencil tpl-left-nav-more-ico am-fr am-margin-right"></i>
                                </a>
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-pencil-square"></span>&nbsp; &nbsp; 添加随想
                    </div>
            ...
            <div class="tpl-block ">
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        ...
                        <!-- 表单开始 -->
                        <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/capriccio/create" method="post"> 
                            <!-- 随想音符 开始 -->
                            <div class="am-form-group">
                                <label for="musicName" class="am-u-sm-3 am-form-label">随想音符</label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="am-radius" id="musicName" name="capNote" placeholder="随想音符" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="am-radius" id="musicSinger" name="capMusic" placeholder="填写随想对应的实际歌曲" required>
                                </div>
                            </div>
                            <!-- 随想乐曲 结束 -->
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="url" class="am-radius" id="musicAlbum" name="capLink" placeholder="随想歌曲网易云音乐链接" required>
                                </div>
                            </div>
                            <!-- 链接 结束 -->
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="capFavor" value="1" name="docInlineRadio"> ★
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="capFavor" value="2" name="docInlineRadio"> ★★
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="capFavor" value="3" name="docInlineRadio"> ★★★
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="capFavor" value="4" name="docInlineRadio"> ★★★★
                                    </label>
                                    <label class="am-radio-inline" >
                                        <input type="radio" name="capFavor" value="5" name="docInlineRadio" checked> ★★★★★
                                    </label>
                                </div>
                            </div>
                            <!-- 喜爱 结束 -->
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <button type="submit" class="am-btn am-btn-primary am-radius">生成随想</button>
                                </div>
                            </div>
                        </form>
                        <!-- 表单结束 -->
